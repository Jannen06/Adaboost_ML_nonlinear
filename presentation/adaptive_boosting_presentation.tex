...
\begin{itemize}
    \item \textbf{Regression:} Minimizes Squared Error (MSE).
    \item \textbf{Classification:} MSE is unreliable.
    \begin{itemize}
        \item Penalizes ``too correct'' predictions.
...
\begin{figure}
    ...
    \caption{\small Breast Cancer Wisconsin (Diagnostic) dataset: 569 FNA-based samples with 30 cell-nucleus features used to classify malignant vs. benign tumors and demonstrate AdaBoost on high-dimensional medical data.}
\end{figure}
